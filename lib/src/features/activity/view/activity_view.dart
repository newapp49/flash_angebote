...
class _ActivityPageState extends State<ActivityPage> {
  ...
  SingleChildScrollView pageBody(
      BuildContext context, ActivityPageCubit cubit) {
  ...
  Widget recommendedFlyerCards(BuildContext context, ActivityPageCubit cubit) {
    return Container(
      padding: context.paddingHorizontal2,
      width: context.width,
      height: 120.h,
  ...
  SizedBox billboardCards(ActivityPageCubit cubit) {
    ...
    timer = Timer.periodic(pageChangeDuration, (Timer timer) {
      _changePage();
    });
